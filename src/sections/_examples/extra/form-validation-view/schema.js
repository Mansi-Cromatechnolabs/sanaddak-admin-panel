...
export const FormSchema = Yup.object().shape({
  ...
  multiUpload: Yup.array().min(2, 'Must have at least 1 items'),
  //
  ...
  multiSelect: Yup.array().min(2, 'Must have at least 1 items'),
  //
  singleCountry: Yup.string().required('Country is required'),
  multiCountry: Yup.array().min(2, 'Must have at least 1 items'),
  //
