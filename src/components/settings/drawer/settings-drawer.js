    ...
    <div>
      ...
      <BaseOptions
        ...
        onChange={(newValue) => {
          ...
          // Change the language based on the direction
          if (newValue === 'ltr') {
            onChangeLang('en'); // Change to English when direction is LTR
          } else if (newValue === 'rtl') {
            onChangeLang('ar'); // Change to Arabic when direction is RTL
          }
        }}
        options={['ltr', 'rtl']}
